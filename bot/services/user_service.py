from bot.db.crud import create_user, get_all_users, delete_user_by_telegram_id

async def add_user(telegram_id, last_name, first_name, middle_name, email, role):
    try:
        user = create_user(
